					...
					<nav class="pagination is-rounded is-centered" role="navigation" aria-label="pagination">
						<ul class="pagination-list">
							...
							if($total_page){
								...
								if($start > 0){
									echo '<li><a class="pagination-link" href="'. get_permalink('post', '', array('page' => 1)) .'">1</a></li>';
								...
								for($i = $start; $i<$end; $i++){
									...
									echo '<li><a class="pagination-link '.$current.'" href="'. get_permalink('post', '', array('page' => $i+1)) .'">'.($i+1).'</a></li>';
								}
								if($end < $total_page){
									echo('<li><span class="page-link">...</span></li>');
									echo '<li><a class="pagination-link" href="'. get_permalink('post', '', array('page' => $total_page)) .'">'.$total_page.'</a></li>';
								}
							}
							?>
						</ul>
