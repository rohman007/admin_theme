				...
				<div class="col-12 col-lg-9">
					...
					<div class="top-3">
						...
						<div class="top-user rank-2">
							<a href="<?php echo get_permalink('user', $user->username) ?>">
								<div class="top-avatar">
									<img src="<?php echo get_user_avatar($user->username) ?>" class="img-fluid">
								</div>
							</a>
							<div class="top-number">
								<img src="<?php echo get_template_path() . '/images/medal-2.svg' ?>" class="img-fluid">
							</div>
						...
						<div class="top-user rank-1">
							...
							<div class="top-number">
								<img src="<?php echo get_template_path() . '/images/medal-1.svg' ?>" class="img-fluid">
							</div>
							<div class="top-username">
								<?php echo $user->username ?>
							</div>
