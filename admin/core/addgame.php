		...
		<div class="tab-pane tab-container fade" id="fetch">
			<div class="mb-3">
				...
				<select name="distributor" class="form-control" id="distributor-options">
					...
					<option data-bs-toggle="tab" value="#gamedistribution">GameDistribution</option>
					<option data-bs-toggle="tab" value="#gamepix">GamePix</option>
					<option data-bs-toggle="tab" value="#more-distributors">More</option>
				</select>
			</div>
